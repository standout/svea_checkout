...
module SveaCheckout
  # The final payment method for the order. Will only have a value when the order is finalized, otherwise null.  Some payment methods might include unique fields that are not available on other payment methods.
  class PaymentInfo
    # The final payment method type for the order:  <ul><li>AccountCredit, </li><li>Card, </li><li>DirectBank, </li><li>Invoice, </li><li>Leasing, </li><li>PaymentPlan, </li><li>Trustly</li></ul>
    ...
    def hash
      [payment_method_type, campaign_code].hash
    end
